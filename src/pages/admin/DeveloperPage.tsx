...
const SERVICES: ServiceDef[] = [
  ...
  { name: 'PII Vault',       url: '/api/pii_vault/api/v1/G/health',                       layer: 'core' },
  { name: 'DataTable',       url: '/api/datatable/api/v1/G/health',                       layer: 'pfs' },
  { name: 'Form Builder',    url: '/api/form_builder/api/v1/G/form_builder/health',       layer: 'pfs' },
  { name: 'Notification',    url: '/api/notification/api/v1/G/notifications/health',      layer: 'pfs' },
  { name: 'PCG4',            url: '/api/pcg4/api/v1/G/health',                           layer: 'app' },
  { name: 'Product Pricing', url: '/api/product_pricing/api/v1/G/product_pricing/health', layer: 'app' },
  { name: 'UW Workflow',     url: '/api/uw_workflow/api/v1/G/uw_workflow/health',         layer: 'app' },
  { name: 'HI UW Decisioning', url: '/api/hi_uw_decisioning/api/v1/G/hi_uw_decisioning/health', layer: 'app' },
  { name: 'HI Quotation',    url: '/api/hi_quotation/api/v1/G/hi_quotation/health',      layer: 'app' },
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
          {[
            ...
            { name: 'PII Vault',      path: '/api/pii_vault' },
            { name: 'PCG4',           path: '/api/pcg4' },
            { name: 'Form Builder',   path: '/api/form_builder' },
            { name: 'UW Workflow',    path: '/api/uw_workflow' },
            { name: 'HI UW Decisioning', path: '/api/hi_uw_decisioning' },
            { name: 'HI Quotation',   path: '/api/hi_quotation' },
